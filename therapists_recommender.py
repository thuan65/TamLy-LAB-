...
PROVINCE_TO_HUB = {
    # South → HCMC
    "ho chi minh": HUB_HCMC, "saigon": HUB_HCMC, "binh duong": HUB_HCMC, "dong nai": HUB_HCMC,
    "can tho": HUB_HCMC, "long an": HUB_HCMC, "kien giang": HUB_HCMC,
    # North → Hanoi
    "ha noi": HUB_HANOI, "hanoi": HUB_HANOI, "hai phong": HUB_HANOI, "thai nguyen": HUB_HANOI,
    "ninh binh": HUB_HANOI, "hai duong": HUB_HANOI,
    # Central → Da Nang
    "da nang": HUB_DN, "danang": HUB_DN, "quang nam": HUB_DN, "quang ngai": HUB_DN,
    "thua thien hue": HUB_DN, "khanh hoa": HUB_DN,
}
